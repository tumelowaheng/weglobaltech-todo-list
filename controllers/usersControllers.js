   ...
   if(foundUser){
      ...
      if(results){
         ...
         .then(()=>{
            ...
            // res.cookie("accessToken",accessToken,{secure:true,httpOnly:true,domain:"www.weglobaltech-todo-list.herokuapp.com",path:"/",SameSite:"none",maxAge:(5*60*60*1000)});
            ...
            res.cookie("accessToken",accessToken,{secure:true,httpOnly:true,domain:"www.weglobaltech-todolist.netlify.app",path:"/",SameSite:"none",maxAge:(5*60*60*1000)});
